...
class Simulator:
    def __init__(self,cfg):
        ...
        self.report=dict(revision=cfg['revision'],status='initializing',error=None,stops=[],
            task_scope='17-demo-envelope delta-action right-arm cup-transfer diagnostic with unchanged 5201-update weights, state-feasible projection and fixed inactive-left-arm hold; NOT complete bimanual project',
