...
EXEC_STEPS=5  # execute 25 ms, then obtain fresh cameras/state and replan
...
class Simulator:
    def __init__(self,cfg):
        ...
        self.report=dict(revision=cfg['revision'],status='initializing',error=None,stops=[],
            task_scope='17-demo-envelope delta-action right-arm cup-transfer diagnostic with unchanged 5201-update weights, 5-step full-arm receding horizon, state-feasible projection and fixed inactive-left-arm hold; NOT complete bimanual project',
            ...
            privileged_state_used_to_steer_policy=False,inactive_left_arm_mask=True,delta_training_envelope_projection=True,delta_current_state_feasibility_projection=True,receding_horizon_steps=5,receding_horizon_sim_s=0.025,control_cadence_matches_training=False,simulator_paused_during_inference=True,
