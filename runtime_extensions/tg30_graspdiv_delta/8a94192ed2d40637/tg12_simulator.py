...
class Simulator:
    def __init__(self,cfg):
        ...
        self.report=dict(revision=cfg['revision'],status='initializing',error=None,stops=[],
            task_scope='expanded grasp-diversity delta-action right-arm cup-transfer diagnostic with state-feasible projection and fixed inactive-left-arm hold; NOT complete bimanual project',
