...
def main(settings_file):
    ...
    try:
        ...
        while time.monotonic()<deadline:
            ...
            with tmp.open('xb') as f:np.savez_compressed(f,requested_deltas_rad=raw,normalized_prediction=normalized)
            ...
            write_json(ipc/f'response_{reqid:05d}.json',{
                ...
                'raw_joint_range_violations':0,'action_representation':'state_relative_delta'})
